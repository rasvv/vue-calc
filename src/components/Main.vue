      ...
      <v-col cols="4" class="calc__selectnuclids borred">
        ...
        <v-row width="100%">
          <div class="nuclids__top">
            <v-col cols="5" class="d-flex flex-column justify-stretch" height="100%">
              <v-radio-group v-model="favoriteNuclids" row class="d-flex justify-start flex-column calc__items">
